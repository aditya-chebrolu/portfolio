...
const Contact = () => {
  return (
    <div className="mt-10 flex justify-center gap-6 [&_svg:hover]:scale-150 [&_svg]:h-[25px] [&_svg]:w-[25px] [&_svg]:fill-black [&_svg]:transition-transform [&_svg]:duration-100 dark:[&_svg]:fill-white">
